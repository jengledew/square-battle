...
namespace Space
{
    class Ship
    {
        ...
        public Ship(GraphicsDevice graphicsDevice)
        {
            ...
            // green, a concave polygon. Define the verticies of green
            this.greenVerts = new Vertices(5);
            this.greenVerts.Add(new Vector2(30, 0));
            this.greenVerts.Add(new Vector2(45, 15));
            this.greenVerts.Add(new Vector2(40, 30));
            this.greenVerts.Add(new Vector2(20, 30));
            this.greenVerts.Add(new Vector2(15, 15));

            //Feed the verts into the BodyFactory
            this.green = BodyFactory.CreatePolygon(world, this.greenVerts, 3.0f);
            this.green.SetTransform(new Vector2(center.X - 100.0f, center.Y + 100f), 0.5f);
            this.green.BodyType = BodyType.Dynamic;
            this.green.ApplyForce(new Vector2(-100.0f, -200.0f));
            this.green.ApplyTorque(100.0f);
        ...
        public void DrawBody(Body body, Color color)
        {
            ...
            foreach (Fixture fixture in body.FixtureList)
            {
                ...
                graphics.DrawUserPrimitives<VertexPositionColor>(PrimitiveType.LineStrip, vertices, 0, i);
            }
        }
